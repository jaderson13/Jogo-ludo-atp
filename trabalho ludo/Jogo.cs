...
namespace trabalho_ludo
{
    internal class Jogo
    {
        ...
        public bool Capturar_peao(int ultimo_peao_coluna,int ultimo_jogador,out int jogador_capturado,out int peao_capturado)
        {
            ...
            /*else
            {
                //subtrair índices dos jogadores multiplicar por 14 e somar na coluna do peão
        ...
        public bool Validar_peao(int peao_escolhido)
        {
            if (peao_escolhido <= 0 || peao_escolhido > 4)
            {
                return true;
            }
