                        ...
                        do
                        {
                            do
                            {
                                ...
                                do
                                {
                                    ...
                                    peao_invalido = ludo.Validar_peao(peao_escolhido);
                                ...
                                jogada_invalida = ludo.vet_jogadores[i].Validar_jogada(jogada_escolhida, ludo.vet_jogadores[i].vet_peoes[peao_escolhido].coluna, out sair_da_casa);
