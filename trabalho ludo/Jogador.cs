...
namespace trabalho_ludo
{
    internal class Jogador
    {
        ...
        public int Jogadas_disponiveis()//recebe peão escolhido
        {
        ...
        public void Mover_peao(int peao_escolhido, int num_dado, out bool checkpoint, out bool peao_vitoria,out bool jogada_invalida)
        {
            ...
            int[] vet_checkpoints = { 1, 9, 14, 22, 27, 35, 40, 48, 52, 53, 54, 55, 56, 57 };//subtrair indices dos jogadores multiplicar por 14, e se for 
            bool casas_iniciais_cheias = true;                                               //indice maior somar com a posição do peão do jogador atual e se for
            peao_vitoria = checkpoint = false;                                               //menor subtrair 
